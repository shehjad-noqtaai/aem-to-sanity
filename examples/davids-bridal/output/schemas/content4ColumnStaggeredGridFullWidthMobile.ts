...
/**
 * Generated from AEM component: /apps/dbi/components/content/4-column-staggered-grid-full-width-mobile
 * DO NOT EDIT BY HAND — regenerate via `pnpm migrate:schema`.
 */
export const content4ColumnStaggeredGridFullWidthMobile = defineType({
  name: "content4ColumnStaggeredGridFullWidthMobile",
  title: "4 Column Staggered Grid Full-Width Mobile",
  type: "object",
  preview: {
    select: {
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          {
            title: "Offset Bottom Left Backdrop",
            value: "component-backdrop__offset--bottom-left",
          },
        ],
      },
    }),
