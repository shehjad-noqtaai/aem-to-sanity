...
/**
 * Generated from AEM component: /apps/dbi/components/content/rich-text-with-light-header
 * DO NOT EDIT BY HAND — regenerate via `pnpm migrate:schema`.
 */
export const contentRichTextWithLightHeader = defineType({
  name: "contentRichTextWithLightHeader",
  title: "Rich Text Editor with Light Header",
  type: "object",
  preview: {
    prepare() {
      return { title: "Rich Text Editor with Light Header" };
    },
  },
  fields: [
    defineField({
